...
func TestLegacyApprovalReceiptRemainsConsumable(t *testing.T) {
	...
	action := contractsv1.ActionArtifact{Kind: contractsv1.ActionArtifactKindActionArtifact, SchemaVersion: 1, Id: "action-1", ArtifactType: "recommendation", JobId: "job-a", CampaignId: "campaign-a", WorkflowRef: "review@1", NodeId: "research", InputHashes: []contractsv1.SHA256{}, Content: content, ContentSha256: contractsv1.SHA256(contentHash), ApprovalState: contractsv1.ActionArtifactApprovalStatePending}
